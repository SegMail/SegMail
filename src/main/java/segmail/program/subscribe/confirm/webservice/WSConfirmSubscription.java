...
public class WSConfirmSubscription implements WSConfirmSubscriptionInterface {
     ...
     * 
     * 3 outcomes:
     * 1) Key is null or empty:
     * Throw a UnwantedAccessException to show users a Landing Page to sign up for our
     * services.
     * 
     * 2) Key/Params cannot be found: 
     * This is a programming fault, the user cannot do anything to rectify it.
     * Throw RuntimeException.
     * 
     * 3) Transaction has already been processed
     * Throw a TransactionProcessedException exception to tell users that their subscription has already
     * been processed and they should be receiving their welcome email soon.
     * 
     * 4) Subscription cannot be found
     * Throw a RuntimeException. If there is a Transaction key and params but no
     * Subscription that means something was changed at the ERP server, which 
     * users can't do anything about.
     * 
     * 5) Subscription is confirmed successfully
