...
public abstract class EntityGraph {
    ...
    public abstract <E extends EnterpriseObject,R extends EnterpriseRelationship> EntityGraph 
        setNextNodeType(Class<E> e, Class<R> r, boolean recursive, NodeType type);
    ...
    /**
     * Iterative method to get the next Edge to be explored.
     * 
     * @param <R>
     * @return 
     */
    ...
    /**
     * Iterative method to get the next Node to be explored.
     * @param <E>
     * @return 
     */
